...
function Footer() {
    return (
       <div className="flex flex-col-reverse lg:flex-row-reverse bg-black  items-center justify-between p-3 w-full">
      <div className="flex  justify-around items-center lg:w-1/4 w-full">
        ...
        <span className="w-6 rounded-full h-6 items-center bg-assure">
          <a><AiFillLinkedin color="blue" size="30" /></a>
        </span>
        <span className="w-6 rounded-full h-6 bg-assure">
         <a><FaTwitter color="Lightblue" size="30" /></a>
        </span>
      </div>
      <div className='grid place-items-center text-justify w-full lg'>
